...
namespace CIS3342TermProject
{
    public class DBConnect
    {
        ...
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa14_3342_tuc53874;User id=tuc53874;Password=Che9Aezo";
        // Database connection string for tunnelling from outside Temple's campus.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=fa14_3342_tuc53874;User id=tuc53874;Password=Che9Aezo";
